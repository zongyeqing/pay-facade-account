...
public interface AccountSettFacade {
     ...
     */
    void settCreateTo(String userNo, Double settAmount, String requestNo, String trxNo)throws AccountBizException;
    /**
     * 结算成功
     *
     * @param userNo
     ...
     * @param riskDay
     */
    void settCollectSucess(String userNo, String statDate, Integer riskDay)throws AccountBizException;
    /**
     * 结算创建
     *
     * @param userNo
